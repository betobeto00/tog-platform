...
-- ---------------------------------------------------------------------------
-- Tablas del sistema de Vendedores (FASE 1)
-- ---------------------------------------------------------------------------
ALTER TABLE vendedores ENABLE ROW LEVEL SECURITY;
ALTER TABLE vendedor_zonas ENABLE ROW LEVEL SECURITY;
ALTER TABLE vendedor_clientes ENABLE ROW LEVEL SECURITY;
...
CREATE INDEX idx_vendedor_clientes_empresa ON vendedor_clientes(cliente_empresa);
CREATE INDEX idx_vendedor_comisiones_vendedor ON vendedor_comisiones(vendedor_id);
CREATE INDEX idx_vendedor_visitas_vendedor ON vendedor_visitas(vendedor_id);
