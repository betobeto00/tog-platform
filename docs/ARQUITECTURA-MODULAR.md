...
| Sync online con backend propio | ✅ Implementado | Backend Node + SQLite/Postgres en Railway (ver FACTURACION-CRIXTO) |
...
- `FACTURACION-CRIXTO.md` — cobro online (Crixto) y sincronización licencia↔pago.
